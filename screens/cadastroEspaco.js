...
export default function CadastroEspaco({route}) {
  const [clubeIdInput, setClubeIdInput] = useState(route?.params?.clube_id ? String(route.params.clube_id) : '');
  ...
  let payload = { nome, clube_id: parseInt(clubeIdInput) };
